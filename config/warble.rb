...
Warbler::Config.new do |config|
  ...
  config.dirs = %w(app config lib log vendor tmp xslt)
...
config.gems += ["activerecord-jdbcmysql-adapter","memcache-client","muruca_widgets","talia_core","rails","jruby-openssl","activerecord-jdbcmysql-adapter","hobo","oai_talia","json_pure","activerdf_net7", "simplyx", "nokogiri", "sunspot"]
