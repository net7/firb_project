...
switch ($what) {
    ...
    if ($result === false) die("Cant execute $q. Make sure the db file is in the right place and the directory is writable by the web server.");
        ...
        echo'<div class="widget widget_draggable">'.
            ...
            '     <h4 class="widgetHeaderTitle">Breeds A-Z</h4>'.
            '      <div class="widgetHeaderTools">'.
            '          <span class="collapse"><a class="expanded" href="#" title="Collapse">Collapse</a></span>'.
            '          <span class="drag"><a href="#" title="Drag">Drag</a></span>'.
            '      </div>'.
            '  </div>'.
    ...
    if ($result === false) die("Cant execute $q. Make sure the db file is in the right place and the directory is writable by the web server.");
        ...
        foreach ($result as $dog) {
            echo'<div class="widget widget_draggable">'.
                '  <div class="widgetHeader">'.
                '     <h4 class="widgetHeaderTitle">Picture</h4>'.
                '      <div class="widgetHeaderTools">'.
                '          <span class="collapse"><a class="expanded" href="#" title="Collapse">Collapse</a></span>'.
                '          <span class="drag"><a href="#" title="Drag">Drag</a></span>'.
                '      </div>'.
                ...
                '  <div class="widgetHeader">'.
                '      <h4 class="widgetHeaderTitle">General description</h4>'.
                '      <div class="widgetHeaderTools">'.
                '          <span class="collapse"><a class="expanded" href="#" title="Collapse">Collapse</a></span>'.
                '          <span class="drag"><a href="#" title="Drag">Drag</a></span>'.
                '      </div>'.
